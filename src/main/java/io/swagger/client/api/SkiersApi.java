...
public class SkiersApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> writeNewLiftRide(LiftRide body, Integer resortID, String seasonID, String dayID, Integer skierID) throws ApiException {
        return writeNewLiftRideWithHttpInfo(body, resortID, seasonID, dayID, skierID);
    }
